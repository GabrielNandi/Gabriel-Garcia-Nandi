...
public class NestedHalbachIronSegmentsModel {
  ...
  public static Model run() {
    ...
    model.geom("geom1").feature("pi4").set("inputexpr", new String[]{"R_g", "R_s", "0[deg]", "1*delta_phi_B_IV"});
