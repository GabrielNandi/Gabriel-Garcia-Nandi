/*
 * SimpleBlocks_explicit_selection_part_union.java
 */

import com.comsol.model.*;
import com.comsol.model.util.*;

/** Model exported on Aug 29 2016, 15:24 by COMSOL 5.2.1.199. */
public class SimpleBlocks_explicit_selection_part_union {

  public static Model run() {
    Model model = ModelUtil.create("Model");

    model.modelPath("C:\\Users\\hanna\\Desktop\\Temp");
    ...
    model.view("view1").axis().set("ymax", "0.019115183502435684");
    model.view("view1").axis().set("xmax", "0.020499998703598976");
    model.view("view1").axis().set("ymin", "-0.004973048344254494");
